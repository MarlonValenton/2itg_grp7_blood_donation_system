...
<style>
    .tableBloodSamp{background-color:white;}
</style>
<body>
    ...
    <div class="container cont">
        ...
        <table class="table table-responsive table-striped  rounded mb-5">
            <tr><th colspan="7" class="title tableBloodSamp">Available Blood Samples</th></tr>
            <tr>
                <th class="tableBloodSamp">#</th>
                <th class="tableBloodSamp">Hospital Name</th>
                <th class="tableBloodSamp">Hospital City</th>
                <th class="tableBloodSamp">Hospital Email</th>
                <th class="tableBloodSamp">Hospital Phone</th>
        ...
        <?php while($row = mysqli_fetch_array($result)) { ?>
            ...
            <tr class="tableBloodSamp"  >
                <td class="tableBloodSamp"s><?php echo ++$counter;?></td>
                ...
                <td class="tableBloodSamp"><a href="javascript:void(0);" class="btn btn-info hospital">Request Sample</a></td>
                <?php } else {(isset($_SESSION['rid']))  ?>
                <td class="tableBloodSamp"><input type="submit" name="request" class="btn btn-info" value="Request Sample"></td>
                <?php } ?>
